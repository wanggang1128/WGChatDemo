...
/**
 ...
 - iPad: 苹果平板电脑设备
 */
typedef NS_ENUM(NSInteger,HuDeviceType) {
    DeviceiPhone=1,
    DeviceiPodTouch,
    DeviceiPad,
};
 ...
 */
typedef NS_ENUM(NSInteger,HuDeviceModel) {
...
@interface HuDeviceDefault : NSObject

+ (HuDeviceDefault *)shareHuDeviceDefault;
- (void)initData;

//设备信息
@property(nonatomic,assign) HuDeviceType deviceType;
@property(nonatomic,assign) HuDeviceModel deviceModel;
